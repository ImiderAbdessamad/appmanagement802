...
public class AppApplication {
    ...
    private void createAppState(){
            AppState itemSuccess = new AppState();
            itemSuccess.setCode("success");
            itemSuccess.setLibelle("Validated");
            appStateService.create(itemSuccess);
            AppState itemDanger = new AppState();
            itemDanger.setCode("danger");
            itemDanger.setLibelle("Blocked");
            appStateService.create(itemDanger);
            AppState itemWarning = new AppState();
            itemWarning.setCode("warning");
            itemWarning.setLibelle("Pending");
            appStateService.create(itemWarning);

    }
    private void createApplicationUserState(){
            ApplicationUserState itemSuccess = new ApplicationUserState();
            itemSuccess.setCode("success");
            itemSuccess.setLibelle("Validated");
            applicationUserStateService.create(itemSuccess);
            ApplicationUserState itemDanger = new ApplicationUserState();
            itemDanger.setCode("danger");
            itemDanger.setLibelle("Blocked");
            applicationUserStateService.create(itemDanger);
            ApplicationUserState itemWarning = new ApplicationUserState();
            itemWarning.setCode("warning");
            itemWarning.setLibelle("Pending");
            applicationUserStateService.create(itemWarning);
    ...
    private static void addPermission(List<ModelPermission> modelPermissions) {
        modelPermissions.add(new ModelPermission("App"));
        modelPermissions.add(new ModelPermission("ApplicationUser"));
        modelPermissions.add(new ModelPermission("AppState"));
        modelPermissions.add(new ModelPermission("AppOwner"));
        modelPermissions.add(new ModelPermission("ApplicationUserState"));
    ...
    @Autowired
    AppStateAdminService appStateService;
    @Autowired
    ApplicationUserStateAdminService applicationUserStateService;
}
