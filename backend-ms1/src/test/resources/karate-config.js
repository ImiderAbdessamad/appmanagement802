function fn() {
    ...
    config.appUrl = config.adminUri + 'app/';
    config.applicationUserUrl = config.adminUri + 'applicationUser/';
    config.appStateUrl = config.adminUri + 'appState/';
    config.appOwnerUrl = config.adminUri + 'appOwner/';
    config.applicationUserStateUrl = config.adminUri + 'applicationUserState/';
