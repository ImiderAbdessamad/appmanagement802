...
export class AppListAdminComponent implements OnInit {
    ...
    appStates: Array<AppStateDto>;
    appOwners: Array<AppOwnerDto>;
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<AppDto>();
    ...
    public async delete(dto: AppDto) {
    ...
    public async duplicate(dto: AppDto) {
    ...
    public exportPdf(dto: AppDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'appState?.libelle', header: 'App state'},
            {field: 'appOwner?.id', header: 'App owner'},
        ];
    }


    public async loadAppState(){
        this.appStateService.findAllOptimized().subscribe(appStates => this.appStates = appStates, error => console.log(error))
    }
    public async loadAppOwner(){
        this.appOwnerService.findAll().subscribe(appOwners => this.appOwners = appOwners, error => console.log(error))
    }


	public initDuplicate(res: AppDto) {
        if (res.applicationUser != null) {
             res.applicationUser.forEach(d => { d.app = null; d.id = null; });
        }
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'App state': e.appState?.libelle ,
                'App owner': e.appOwner?.id ,
            }
        });
        ...
        //'App state': this.criteria.appState?.libelle ? this.criteria.appState?.libelle : environment.emptyForExport ,
        //'App owner': this.criteria.appOwner?.id ? this.criteria.appOwner?.id : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<AppDto> {
        return this.service.selections;
    }

    set selections(value: Array<AppDto>) {
