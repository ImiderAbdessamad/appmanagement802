...
@Component({
  selector: 'app-application-user-edit-admin',
  templateUrl: './application-user-edit-admin.component.html'
})
export class ApplicationUserEditAdminComponent implements OnInit {
 ...
 public edit(): void {
   ...
   public async openCreateApplication(application: string) {
        const isPermistted = await this.roleService.isPermitted('App', 'edit');
        if (isPermistted) {
