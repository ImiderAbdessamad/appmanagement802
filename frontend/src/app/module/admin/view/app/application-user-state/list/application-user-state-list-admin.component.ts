...
@Component({
  selector: 'app-application-user-state-list-admin',
  templateUrl: './application-user-state-list-admin.component.html'
})
export class ApplicationUserStateListAdminComponent implements OnInit {

    protected fileName = 'ApplicationUserState';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ApplicationUserStateDto>();
    ...
    public async edit(dto: ApplicationUserStateDto) {
    ...
    public async view(dto: ApplicationUserStateDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ApplicationUserStateDto) {
    ...
    public async duplicate(dto: ApplicationUserStateDto) {
    ...
    public exportPdf(dto: ApplicationUserStateDto): void {
...
// add
	...
	public initDuplicate(res: ApplicationUserStateDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ApplicationUserStateDto> {
        return this.service.selections;
    }

    set selections(value: Array<ApplicationUserStateDto>) {
