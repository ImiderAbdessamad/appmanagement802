...
@Component({
  selector: 'app-application-user-state-edit-admin',
  templateUrl: './application-user-state-edit-admin.component.html'
})
export class ApplicationUserStateEditAdminComponent implements OnInit {
