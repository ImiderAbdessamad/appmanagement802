...
@Component({
  selector: 'app-application-user-state-view-admin',
  templateUrl: './application-user-state-view-admin.component.html'
})
export class ApplicationUserStateViewAdminComponent implements OnInit {
    ...
    constructor(private service: ApplicationUserStateAdminService){
