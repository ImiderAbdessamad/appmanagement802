...
@Component({
  selector: 'app-app-state-list-admin',
  templateUrl: './app-state-list-admin.component.html'
})
export class AppStateListAdminComponent implements OnInit {

    protected fileName = 'AppState';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<AppStateDto>();
    ...
    public async edit(dto: AppStateDto) {
    ...
    public async view(dto: AppStateDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: AppStateDto) {
    ...
    public async duplicate(dto: AppStateDto) {
    ...
    public exportPdf(dto: AppStateDto): void {
...
// add
	...
	public initDuplicate(res: AppStateDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<AppStateDto> {
        return this.service.selections;
    }

    set selections(value: Array<AppStateDto>) {
