...
@Component({
  selector: 'app-app-state-view-admin',
  templateUrl: './app-state-view-admin.component.html'
})
export class AppStateViewAdminComponent implements OnInit {
    ...
    constructor(private service: AppStateAdminService){
