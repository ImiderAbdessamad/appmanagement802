...
@Component({
  selector: 'app-app-owner-view-admin',
  templateUrl: './app-owner-view-admin.component.html'
})
export class AppOwnerViewAdminComponent implements OnInit {
    ...
    constructor(private service: AppOwnerAdminService){
